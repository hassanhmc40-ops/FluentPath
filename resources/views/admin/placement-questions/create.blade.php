...
@section('title', 'Admin — New Placement Question')

@section('content')
<div class="max-w-lg">
    <h1 class="text-2xl font-bold mb-6">New Placement Question</h1>

    <form method="POST" action="{{ route('admin.placement-questions.store') }}" class="bg-white rounded-lg shadow p-6">
        @csrf
