...
return [
    ...
    'title' => 'English Mentor AI API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'English Mentor AI (FluentPath) — holistic CEFR placement test, AI-generated 4-week roadmap and AI writing correction. Every AI call runs asynchronously (Laravel jobs + database queue) and results are validated against strict JSON schemas.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Get a token by calling `POST /api/register` (new account) or `POST /api/login`, then send it as `Authorization: Bearer {token}`.',
    ],
